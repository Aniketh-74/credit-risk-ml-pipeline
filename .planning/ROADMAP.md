...
Plans:
- [x] 03-01-PLAN.md — Backward fix to train.py/evaluate.py (imputer artifact + Youden threshold), FastAPI lifespan, /health endpoint, and Pydantic schemas (Wave 1)
- [ ] 03-02-PLAN.md — Split-path router, inference preprocessing helper, and POST /score endpoint (Wave 2)
- [ ] 03-03-PLAN.md — POST /outcome, async BackgroundTask prediction logging, and API integration test suite (Wave 3)
...
Plans:
- [ ] 04-01-PLAN.md — Denial loop and score gaming simulators with label delay modeling
- [ ] 04-02-PLAN.md — CB-PDD algorithm port — CheckerBoardPredictor, DensityChangeTracker, PerformativeDriftDetector
- [ ] 04-03-PLAN.md — Drift scorer integrating PostgreSQL reads, PSI computation, and CB-PDD output
- [ ] 04-04-PLAN.md — Integration verification and full test suite pass (evidence collection)
...
| 4. Proving the Feedback Loop | 1/4 | In Progress|  |
