...
- [x] **MODEL-01**: LightGBM model trained on Give Me Credit dataset (150k rows, AUC > 0.85) with SMOTE for class imbalance
- [x] **MODEL-02**: All training runs logged to MLflow — hyperparameters, AUC, precision-recall curve, feature importances
